...
export const pt = {
  ...
  productDesc: "Crie ferramentas internas rapidamente, sem limitações",
  notSupportedBrowser:
    "Seu navegador atual pode ter problemas de compatibilidade. Para uma melhor experiência do usuário, é recomendado usar a versão mais recente do navegador Chrome.",
  create: "Criar",
  move: "Mover",
  addItem: "Adicionar",
  newItem: "Novo",
  ...
  api: {
    ...
    needUpdate: "Sua versão atual é muito antiga, atualize para a versão mais recente.",
  },
  codeEditor: {
  ...
  exportMethod: {
    setDesc: "Alterar propriedade: {property}",
    clearDesc: "Apagar propriedade: {property}",
    resetDesc: "Redefinir propriedade: {property} para o valor padrão",
  },
  method: {
    focus: "Definir foco",
    focusOptions: "Opções de foco. Consulte HTMLElement.focus()",
    blur: "Remover foco",
    click: "Clique",
    select: "Selecionar todo o texto",
    setSelectionRange: "Definir as posições inicial e final da seleção do texto atual",
    selectionStart: "O índice 0-based do primeiro caractere selecionado.",
    selectionEnd: "O índice 0-based após o último caractere selecionado.",
    setRangeText: "Substituir um intervalo de texto",
    replacement: "A string a ser inserida.",
    replaceStart: "O índice 0-based do primeiro caractere a ser substituído.",
    replaceEnd: "O índice 0-based após o último caractere a ser substituído.",
  },
  errorBoundary: {
    encounterError: "Falha ao carregar componentes. Verifique sua configuração. ",
    clickToReload: "Clique para recarregar",
    errorMsg: "Erro: ",
  },
  imgUpload: {
    notSupportError: "Suporta apenas upload de {types} imagens",
    exceedSizeError: "O tamanho da imagem não deve exceder {size}",
  },
  gridCompOperator: {
    notSupport: "Não suporta",
    selectAtLeastOneComponent: "Por favor selecione apenas um componente",
    selectCompFirst: "Selecione os componentes antes de copiar",
    noContainerSelected: "[bug] Nenhum contêiner selecionado",
    deleteCompsSuccess: "Exclusão concluída. Você pode usar {undoKey} para desfazer.",
    deleteCompsTitle: "Excluir componentes",
    deleteCompsBody: "Tem certeza que deseja excluir {compNum} componentes selecionados?",
    cutCompsSuccess: "Corte bem sucedido. Você pode usar {pasteKey} para colar ou usar {undoKey} para desfazer.",
  },
  leftPanel: {
    queries: "Consultas",
    globals: "Globais",
    ...
    modals: "Modais",
    expandTip: "Clique para expandir os dados de {component}'s",
    collapseTip: "Clique para recolher os dados de {component}'s",
  },
  bottomPanel: {
    title: "Consultas",
    run: "Executar",
  ...
  rightPanel: {
    ...
    noSelectedComps: "Nenhum componente selecionado. Clique para selecionar um.",
    createTab: "Inserir",
    searchPlaceHolder: "Pesquisar componentes ou módulos",
    uiComponentTab: "Componentes",
    extensionTab: "Extensões",
    modulesTab: "Módulos",
    moduleListTitle: "Módulos",
    pluginListTitle: "Plugins",
    emptyModules: "Módulos são grupos reutilizáveis de componentes e consultas.",
    searchNotFound: "Não consegue encontrar um componente adequado? Envie um problema",
